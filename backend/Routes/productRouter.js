...
const { getAllProducts, updateProduct, deleteproduct, getproduct, createProductReview, getProductReviews, deleteReview, createproduct } = require("../Controllers/productController");
